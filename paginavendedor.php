...
<body>
    ...
    <div class="inventario">
        ...
        <div class="productos-inventario">
            ...
            <?php if ($resProductos && $resProductos->num_rows > 0) { ?>
    ...
    <div class="top-ventas">
        ...
        <div class="productos-top">
            ...
            <?php if ($resTopVentas && $resTopVentas->num_rows > 0) { ?>

                <?php while ($venta = $resTopVentas->fetch_assoc()) { ?>
                    ...
                    <div class="producto-top">
                        ...
                        <div class="producto-top-info">
                            ...
                            <h2>
                                <?php echo htmlspecialchars($venta['NombreProducto']); ?>
                            </h2>

                            <p>
                                <?php echo htmlspecialchars($venta['total_vendido']); ?> vendidos
                            </p>

                        </div>

                        <div class="producto-top-imagen">
