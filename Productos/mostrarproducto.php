...
if($resultado->num_rows > 0){
    ...
    while($fila = $resultado->fetch_assoc()){
        ...
        echo "<p><span>Nombre:</span> ".$fila['NombreProducto']."</p>";
        echo "<p><span>Precio:</span> Bs ".$fila['PrecioProducto']."</p>";
        echo "<p><span>Detalle:</span> ".$fila['DetalleProducto']."</p>";
        echo "<p><span>Stock:</span> ".$fila['Stock']."</p>";
        echo "<p><span>Costo:</span> Bs ".$fila['CostoProducto']."</p>";
